        ...
        >
          <div class="text-center">
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white mb-6">
              Toddler Moms (3-5yrs Moms)
            </h1>
            <p class="text-xl text-neutral-600 dark:text-pink-200 max-w-2xl mx-auto">
              Guide your toddler through this exciting and challenging phase.
            </p>
          </div>
        </Motion>
      </div>
      ...
      <div class="mx-auto max-w-7xl">
        ...
        >
          <div class="grid grid-cols-1 gap-8">
            <ContentCard>
              <template #title>Parenting Toddlers</template>
              <template #description>
                Tips and strategies for managing the toddler years with confidence.
              </template>
            </ContentCard>
          </div>
        </Motion>
