        ...
        >
          <div class="text-center">
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white mb-6">
              Teens Moms (13-19 yrs Moms)
            </h1>
            <p class="text-xl text-neutral-600 dark:text-pink-200 max-w-2xl mx-auto">
              Guide your teenager through adolescence with understanding and support.
            </p>
          </div>
        </Motion>
      </div>
      ...
      <div class="mx-auto max-w-7xl">
        ...
        >
          <div class="grid grid-cols-1 gap-8">
            <ContentCard>
              <template #title>Parenting Teens</template>
              <template #description>
                Understand the teenage years and nurture a strong relationship with your teen.
              </template>
            </ContentCard>
          </div>
        </Motion>
