        ...
        >
          <div class="text-center">
            ...
            <p class="text-xl text-neutral-600 dark:text-pink-200 max-w-2xl mx-auto">
              Prepare for your journey into motherhood with expert guidance and support.
            </p>
          </div>
        </Motion>
      </div>
      ...
      <div class="mx-auto max-w-7xl">
        ...
        >
          <div class="grid grid-cols-1 gap-8">
            <ContentCard>
              <template #title>Preparing for Motherhood</template>
              <template #description>
                Learn about the physical and emotional changes you can expect during pregnancy.
              </template>
            </ContentCard>
          </div>
        </Motion>
