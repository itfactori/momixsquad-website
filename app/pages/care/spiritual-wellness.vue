        ...
        >
          <div class="text-center">
            ...
            <p class="text-xl text-neutral-600 dark:text-pink-200 max-w-2xl mx-auto">
              Nurture your spiritual growth and inner peace.
            </p>
          </div>
        </Motion>
      </div>
      ...
      <div class="mx-auto max-w-7xl">
        ...
        >
          <div class="grid grid-cols-1 gap-8">
            <ContentCard>
              <template #title>Spiritual Growth</template>
              <template #description>
                Explore practices and resources to deepen your spiritual wellness journey.
              </template>
            </ContentCard>
          </div>
        </Motion>
