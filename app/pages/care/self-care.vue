        ...
        >
          <div class="text-center">
            ...
            <p class="text-xl text-neutral-600 dark:text-pink-200 max-w-2xl mx-auto">
              Prioritize your health and well-being as a mom.
            </p>
          </div>
        </Motion>
      </div>
      ...
      <div class="mx-auto max-w-7xl">
        ...
        >
          <div class="grid grid-cols-1 gap-8">
            <ContentCard>
              <template #title>Your Self-Care Journey</template>
              <template #description>
                Discover ways to care for yourself and maintain your wellness while being a mom.
              </template>
            </ContentCard>
          </div>
        </Motion>
